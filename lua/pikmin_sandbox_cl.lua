...
hook.Add("PopulateToolMenu","PikiToolMenu",function()
	spawnmenu.AddToolMenuOption("Utilities","Pikmin","PikiSettings","#pikimenu.settings","","",function(panel)
		...
		local carryallbox = panel:CheckBox("#pikimenu.carryall", "pik_carry_all")
		panel:ControlHelp("#pikimenu.carryall2")
		local showcarrybox = panel:CheckBox("#pikimenu.alwaysshowcarry", "pik_always_show_carry")
		panel:ControlHelp("#pikimenu.alwaysshowcarry2")
