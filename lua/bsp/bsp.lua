include("bsp/types.lua")
include("bsp/tasks.lua")
...
local function LoadBSP( bsp, path, lumps, callback )
...
BSP.LoadBSP = function(mapname)
	return LoadBSP(mapname,nil,LUMPS_DEFAULT,BLOCK_THREAD)
end
